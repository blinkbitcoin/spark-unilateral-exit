...
const names = ["status", "create", "createFromBundle", "addProfile", "addProfileFromBundle", "selectProfile", "generatePassword", "unlock", "lock", "configure", "configureBitcoin", "refresh", "autoRefresh", "keepUnlocked",
